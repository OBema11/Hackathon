...
import cont from './cont/cont.jpeg'
        ...
        <div className="Contact" style={{display:'flex'}}>
              ...
              <>
                <div className="container" style={{display: 'flex'}} >
                                ...
                                <img width="600" height="400" src={cont} alt="we" />
                             <p>Do you have a question about an order, a sold-out item, or something else? Then take a look at our FAQ.
